...
public class StoreTests {
    ...
    protected void valid_deposit_checking_order_should_output_itself() {
        ...
        int i = 0;
        assertEquals(outputValid(CHECKING_ID_1), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(5)), receipt.get(i)); i++;
        assertEquals(outputValid(""), receipt.get(i)); i++;
    ...
    protected void valid_deposit_savings_order_should_output_itself() {
        ...
        store.getOrder().add(5, String.format("%s %s %s", transactionType, SAVINGS_ID_1, savingsDepositAmount));
    ...
    protected void valid_withdraw_order_should_output_itself() {
        ...
        assertEquals(outputValid(CHECKING_ID_1), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(5)), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(8)), receipt.get(i)); i++;
        assertEquals(outputValid(""), receipt.get(i)); i++;

        assertEquals(outputValid(SAVINGS_ID_1), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(6)), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(9)), receipt.get(i)); i++;
        assertEquals(outputValid(""), receipt.get(i)); i++;

        assertEquals(outputValid(CD_ID), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(10)), receipt.get(i)); i++;
        assertEquals(outputValid(""), receipt.get(i)); i++;
    ...
    protected void valid_transfer_order_should_output_itself_twice() {
        ...
        assertEquals(outputValid(store.getOrder().get(5)), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(10)), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(11)), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(12)), receipt.get(i)); i++;
        assertEquals(outputValid(""), receipt.get(i)); i++;
        ...
        assertEquals(outputValid(SAVINGS_ID_1), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(7)), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(11)), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(12)), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(13)), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(14)), receipt.get(i)); i++;
        assertEquals(outputValid(""), receipt.get(i)); i++;
    ...
    protected void valid_order_should_output_lower_case_and_trim_useless_additional_arguments() {
        ...
        int i = 0;
        assertEquals(outputValid(CHECKING_ID_1), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(6), 4), receipt.get(i)); i++;
        assertEquals(outputValid(""), receipt.get(i)); i++;

        assertEquals(outputValid(SAVINGS_ID_0), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(5), 3), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(6), 4), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(8), 3), receipt.get(i)); i++;
        assertEquals(outputValid(""), receipt.get(i)); i++;
    ...
    protected void order_should_output_by_validity_id_and_then_time() {
        ...
        int i = 0;
        assertEquals(outputValid(SAVINGS_ID_1), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(1)), receipt.get(i)); i++;
        assertEquals(outputValid(store.getOrder().get(5)), receipt.get(i)); i++;
        assertEquals(outputValid(""), receipt.get(i)); i++;
    ...
    protected void stuff() {
        invalid_create_order_should_output_itself_as_invalid();
        order_should_output_by_validity_id_and_then_time();
    }
}
