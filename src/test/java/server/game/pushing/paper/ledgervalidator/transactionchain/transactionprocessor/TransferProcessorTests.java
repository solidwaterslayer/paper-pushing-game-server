...
public class TransferProcessorTests {
    ...
    protected void transfer_from_cd_to_savings_transaction_should_process() {
        ...
        assertEquals(BankTests.passTime(APR, bank.getMinBalanceFee(), AccountType.Savings, SAVINGS_DEPOSIT_AMOUNT, months) + BankTests.passTime(APR, bank.getMinBalanceFee(), AccountType.CD, INITIAL_CD_BALANCE, months), bank.getAccount(SAVINGS_ID_1).getBalance());
    }
